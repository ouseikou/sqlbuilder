...
const file_proto_api_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2\x12.proto.TemplateArgR\x05value:\x028\x01\"\xa9\x03\n" +
	"\fSqlReference\x12 \n" +
	"\x04from\x18\x01 \x01(\v2\f.proto.TableR\x04from\x12\x1f\n" +
	...
	"\x05table\x18\x02 \x01(\v2\f.proto.TableR\x05table\x12+\n" +
	...
	"\f_str_literal\"\xff\x01\n" +
	"\aMixVars\x12'\n" +
	"\x06column\x18\x01 \x01(\v2\r.proto.ColumnH\x00R\x06column\x123\n" +
	"\n" +
	"expression\x18\x02 \x01(\v2\x11.proto.ExpressionH\x00R\n" +
	"expression\x12\x1a\n" +
	"\acontext\x18\x03 \x01(\tH\x00R\acontext\x12\x18\n" +
	"\x06number\x18\x04 \x01(\x03H\x00R\x06number\x12\x1f\n" +
	"\n" +
	"double_num\x18\x05 \x01(\x01H\x00R\tdoubleNum\x127\n" +
	"\vstr_literal\x18\x06 \x01(\v2\x14.proto.StringLiteralH\x00R\n" +
	"strLiteralB\x06\n" +
	"\x04vars\"\x9f\x01\n" +
	"\bMixField\x12'\n" +
	"\x06column\x18\x01 \x01(\v2\r.proto.ColumnH\x00R\x06column\x123\n" +
	...
	"\x04then\x18\x02 \x01(\v2\x10.proto.BasicDataR\x04then\"e\n" +
	"\tLogicNode\x12)\n" +
...
var file_proto_api_proto_goTypes = []any{
	...
	(*JoinCond)(nil),               // 14: proto.JoinCond
	(*OnField)(nil),                // 15: proto.OnField
	(*OrderBy)(nil),                // 16: proto.OrderBy
	(*Limit)(nil),                  // 17: proto.Limit
	(*Column)(nil),                 // 18: proto.Column
	(*Expression)(nil),             // 19: proto.Expression
	(*MixVars)(nil),                // 20: proto.MixVars
	(*MixField)(nil),               // 21: proto.MixField
	(*CaseWhen)(nil),               // 22: proto.CaseWhen
	(*CaseWhenItem)(nil),           // 23: proto.CaseWhenItem
	(*LogicNode)(nil),              // 24: proto.LogicNode
	(*LogicGroup)(nil),             // 25: proto.LogicGroup
	(*MixWhere)(nil),               // 26: proto.MixWhere
	(*Condition)(nil),              // 27: proto.Condition
	(*StringLiteral)(nil),          // 28: proto.StringLiteral
	(*BasicData)(nil),              // 29: proto.BasicData
	(*BasicDataArr)(nil),           // 30: proto.BasicDataArr
	(*TemplateArg)(nil),            // 31: proto.TemplateArg
	(*AnalyzeTemplateRequest)(nil), // 32: proto.AnalyzeTemplateRequest
	(*AnalyzeAdditionRequest)(nil), // 33: proto.AnalyzeAdditionRequest
	nil,                            // 34: proto.CommonResponse.DataEntry
	nil,                            // 35: proto.SqlText.ArgsEntry
	nil,                            // 36: proto.AnalyzeTemplateRequest.ArgsEntry
}
var file_proto_api_proto_depIdxs = []int32{
	34, // 0: proto.CommonResponse.data:type_name -> proto.CommonResponse.DataEntry
	...
	35, // 7: proto.SqlText.args:type_name -> proto.SqlText.ArgsEntry
	12, // 8: proto.SqlReference.from:type_name -> proto.Table
	13, // 9: proto.SqlReference.join:type_name -> proto.Join
	26, // 10: proto.SqlReference.where:type_name -> proto.MixWhere
	21, // 11: proto.SqlReference.group_by:type_name -> proto.MixField
	19, // 12: proto.SqlReference.aggregation:type_name -> proto.Expression
	21, // 13: proto.SqlReference.select:type_name -> proto.MixField
	16, // 14: proto.SqlReference.order_by:type_name -> proto.OrderBy
	17, // 15: proto.SqlReference.limit:type_name -> proto.Limit
	25, // 16: proto.SqlReference.logic_where:type_name -> proto.LogicGroup
	3,  // 17: proto.Join.type:type_name -> proto.JoinType
	12, // 18: proto.Join.table:type_name -> proto.Table
	14, // 19: proto.Join.joinCond:type_name -> proto.JoinCond
	15, // 20: proto.JoinCond.onField:type_name -> proto.OnField
	27, // 21: proto.JoinCond.onCond:type_name -> proto.Condition
	21, // 22: proto.OnField.left:type_name -> proto.MixField
	21, // 23: proto.OnField.right:type_name -> proto.MixField
	5,  // 24: proto.OnField.on:type_name -> proto.Op
	4,  // 25: proto.OnField.logic:type_name -> proto.Logic
	21, // 26: proto.OrderBy.dependent:type_name -> proto.MixField
	2,  // 27: proto.Expression.call_type:type_name -> proto.CallType
	20, // 28: proto.Expression.vars:type_name -> proto.MixVars
	28, // 29: proto.Expression.str_literal:type_name -> proto.StringLiteral
	18, // 30: proto.MixVars.column:type_name -> proto.Column
	19, // 31: proto.MixVars.expression:type_name -> proto.Expression
	28, // 32: proto.MixVars.str_literal:type_name -> proto.StringLiteral
	18, // 33: proto.MixField.column:type_name -> proto.Column
	19, // 34: proto.MixField.expression:type_name -> proto.Expression
	22, // 35: proto.MixField.case_when:type_name -> proto.CaseWhen
	23, // 36: proto.CaseWhen.conditions:type_name -> proto.CaseWhenItem
	29, // 37: proto.CaseWhen.else_value:type_name -> proto.BasicData
	26, // 38: proto.CaseWhenItem.when:type_name -> proto.MixWhere
	29, // 39: proto.CaseWhenItem.then:type_name -> proto.BasicData
	25, // 40: proto.LogicNode.group:type_name -> proto.LogicGroup
	26, // 41: proto.LogicNode.leaf:type_name -> proto.MixWhere
	4,  // 42: proto.LogicGroup.logic:type_name -> proto.Logic
	24, // 43: proto.LogicGroup.children:type_name -> proto.LogicNode
	27, // 44: proto.MixWhere.condition:type_name -> proto.Condition
	19, // 45: proto.MixWhere.expression:type_name -> proto.Expression
	21, // 46: proto.Condition.field:type_name -> proto.MixField
	29, // 47: proto.Condition.args:type_name -> proto.BasicData
	5,  // 48: proto.Condition.operator:type_name -> proto.Op
	4,  // 49: proto.Condition.logic:type_name -> proto.Logic
	28, // 50: proto.Condition.literal_cond:type_name -> proto.StringLiteral
	28, // 51: proto.BasicData.str_literal:type_name -> proto.StringLiteral
	29, // 52: proto.BasicDataArr.args:type_name -> proto.BasicData
	30, // 53: proto.TemplateArg.val_items:type_name -> proto.BasicDataArr
	36, // 54: proto.AnalyzeTemplateRequest.args:type_name -> proto.AnalyzeTemplateRequest.ArgsEntry
	31, // 55: proto.SqlText.ArgsEntry.value:type_name -> proto.TemplateArg
	31, // 56: proto.AnalyzeTemplateRequest.ArgsEntry.value:type_name -> proto.TemplateArg
	7,  // 57: proto.SqlBuilderApi.Generate:input_type -> proto.BuilderRequest
	32, // 58: proto.SqlBuilderApi.AnalyzeTemplate:input_type -> proto.AnalyzeTemplateRequest
	6,  // 59: proto.SqlBuilderApi.Generate:output_type -> proto.CommonResponse
	6,  // 60: proto.SqlBuilderApi.AnalyzeTemplate:output_type -> proto.CommonResponse
