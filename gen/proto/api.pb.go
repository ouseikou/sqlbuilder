...
const file_proto_api_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2\x12.proto.TemplateArgR\x05value:\x028\x01\"\xe0\x02\n" +
	"\fSqlReference\x12 \n" +
	...
	"\x05limit\x18\b \x01(\v2\f.proto.LimitH\x00R\x05limit\x88\x01\x01B\b\n" +
	"\x06_limit\"j\n" +
	"\x05Table\x12\x1d\n" +
	"\n" +
	...
	"\x04then\x18\x02 \x01(\v2\x10.proto.BasicDataR\x04then\"{\n" +
	"\bMixWhere\x120\n" +
...
var file_proto_api_proto_goTypes = []any{
	...
	(*MixWhere)(nil),               // 24: proto.MixWhere
	(*Condition)(nil),              // 25: proto.Condition
	(*StringLiteral)(nil),          // 26: proto.StringLiteral
	(*BasicData)(nil),              // 27: proto.BasicData
	(*BasicDataArr)(nil),           // 28: proto.BasicDataArr
	(*TemplateArg)(nil),            // 29: proto.TemplateArg
	(*AnalyzeTemplateRequest)(nil), // 30: proto.AnalyzeTemplateRequest
	(*AnalyzeAdditionRequest)(nil), // 31: proto.AnalyzeAdditionRequest
	nil,                            // 32: proto.CommonResponse.DataEntry
	nil,                            // 33: proto.SqlText.ArgsEntry
	nil,                            // 34: proto.AnalyzeTemplateRequest.ArgsEntry
}
var file_proto_api_proto_depIdxs = []int32{
	32, // 0: proto.CommonResponse.data:type_name -> proto.CommonResponse.DataEntry
	...
	33, // 7: proto.SqlText.args:type_name -> proto.SqlText.ArgsEntry
	12, // 8: proto.SqlReference.from:type_name -> proto.Table
	13, // 9: proto.SqlReference.join:type_name -> proto.Join
	24, // 10: proto.SqlReference.where:type_name -> proto.MixWhere
	...
	14, // 18: proto.Join.joinCond:type_name -> proto.JoinCond
	15, // 19: proto.JoinCond.onField:type_name -> proto.OnField
	25, // 20: proto.JoinCond.onCond:type_name -> proto.Condition
	21, // 21: proto.OnField.left:type_name -> proto.MixField
	21, // 22: proto.OnField.right:type_name -> proto.MixField
	5,  // 23: proto.OnField.on:type_name -> proto.Op
	4,  // 24: proto.OnField.logic:type_name -> proto.Logic
	21, // 25: proto.OrderBy.dependent:type_name -> proto.MixField
	2,  // 26: proto.Expression.call_type:type_name -> proto.CallType
	20, // 27: proto.Expression.vars:type_name -> proto.MixVars
	26, // 28: proto.Expression.str_literal:type_name -> proto.StringLiteral
	18, // 29: proto.MixVars.column:type_name -> proto.Column
	19, // 30: proto.MixVars.expression:type_name -> proto.Expression
	26, // 31: proto.MixVars.str_literal:type_name -> proto.StringLiteral
	18, // 32: proto.MixField.column:type_name -> proto.Column
	19, // 33: proto.MixField.expression:type_name -> proto.Expression
	22, // 34: proto.MixField.case_when:type_name -> proto.CaseWhen
	23, // 35: proto.CaseWhen.conditions:type_name -> proto.CaseWhenItem
	27, // 36: proto.CaseWhen.else_value:type_name -> proto.BasicData
	24, // 37: proto.CaseWhenItem.when:type_name -> proto.MixWhere
	27, // 38: proto.CaseWhenItem.then:type_name -> proto.BasicData
	25, // 39: proto.MixWhere.condition:type_name -> proto.Condition
	19, // 40: proto.MixWhere.expression:type_name -> proto.Expression
	21, // 41: proto.Condition.field:type_name -> proto.MixField
	27, // 42: proto.Condition.args:type_name -> proto.BasicData
	5,  // 43: proto.Condition.operator:type_name -> proto.Op
	4,  // 44: proto.Condition.logic:type_name -> proto.Logic
	26, // 45: proto.BasicData.str_literal:type_name -> proto.StringLiteral
	27, // 46: proto.BasicDataArr.args:type_name -> proto.BasicData
	28, // 47: proto.TemplateArg.val_items:type_name -> proto.BasicDataArr
	34, // 48: proto.AnalyzeTemplateRequest.args:type_name -> proto.AnalyzeTemplateRequest.ArgsEntry
	29, // 49: proto.SqlText.ArgsEntry.value:type_name -> proto.TemplateArg
	29, // 50: proto.AnalyzeTemplateRequest.ArgsEntry.value:type_name -> proto.TemplateArg
	7,  // 51: proto.SqlBuilderApi.Generate:input_type -> proto.BuilderRequest
	30, // 52: proto.SqlBuilderApi.AnalyzeTemplate:input_type -> proto.AnalyzeTemplateRequest
	6,  // 53: proto.SqlBuilderApi.Generate:output_type -> proto.CommonResponse
	6,  // 54: proto.SqlBuilderApi.AnalyzeTemplate:output_type -> proto.CommonResponse
